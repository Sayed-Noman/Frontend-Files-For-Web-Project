...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="police_css/police_registration_css.css">
        ...
        <div class="container">
           ...
           <div class="row100">
            ...
            <div class="row100">
                <div class="col">
                    <div class="inputBox shorten-input">
                        <input  class="email" type="text" name="Email" value="<?= isset($Email) ? $Email:'' ?>">
            ...
            <div class="row100">
                <div class="col">
                       <div class="inputBox shorten-input">
                           <input  type="text" name="Birth_Date" onfocus="(this.type='date')"  onblur="(this.type='text')"  value="<?= isset($Birth_Date) ? $Birth_Date:'' ?>">
   ...
   <br><input type="file" accept="image/*" onchange="preview_image(event)" name="Nid_Image" >
...
function preview_image(event) 
{
 ...
 reader.readAsDataURL(event.target.files[0]);
         ...
         <div class="row100">
            <div class="col">
                   <div class="inputBox">
                       <input type="text" name="Badge_Id" value="<?= isset($Badge_Id) ? $Badge_Id:'' ?>" >
                       <span class="text">Badge Id</span>
                       <span class="line"></span>
               </div>
            </div>
                <h4>**Upload Your Batch No. for varification**</h4>
 <input type="file" accept="image/*" onchange="loadFile(event)" name="Badge_Image">
<img id="output"/>
        ...
        <div class="row100">
            <div class="col">
                <div class="inputBox textarea">
                    <textarea name="Security_Question_Answer" id=""  cols="20" rows="7" ></textarea>
