...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="driver_css/driver_registration_css.css">
           ...
           <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
            <div class="row100">
                ...
                <div class="row100">
                    <div class="col">
                        <div class="inputBox shorten-input">
                            <input  class="email-input" type="email" name="Email" value="<?= isset($Email) ? $Email:'' ?>" >
                ...
                <div class="row100">
                    <div class="col">
                        <div class="inputBox shorten-input">
                            <input type="number" name="Phone_Number" value="<?= isset($Phone_Number) ? $Phone_Number:'' ?>">
            ...
            <div class="row100">
                <div class="col">
                    <div class="inputBox shorten-input">
                        <input type="number" name="Nid" value="<?= isset($Nid) ? $Nid:'' ?>">
    ...
    reader.readAsDataURL(event.target.files[0]);
            ...
            <div class="row100">
                <div class="col">
                    <div class="inputBox">
                        <input type="number" name="Driving_License_No" value="<?= isset($Driving_License_No) ? $Driving_License_No:'' ?>" >
                        <span class="text">Driving License No.</span>
                        <span class="line"></span>
                </div>
                </div>
                    <h4>**Upload Your Driving License  No. for varification**</h4>
    <input type="file" name="Driving_License_Image" accept="image/*" onchange="loadFile(event)" >
    <img id="output"/>
    <script>
