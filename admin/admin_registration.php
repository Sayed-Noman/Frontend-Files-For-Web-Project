...
<html>
    ...
    <div class="page-wrapper">
        ...
        <div class="container">
           ...
           <div class="register-input-errors">
               <?php 
                    ...
                    if(isset($Registration_Input_Errors['Pincode'])){
                        echo '<span>'.$Registration_Input_Errors['Pincode'].'</span>';
                    }
           ...
           <div class="row100">
            ...
            <div class="row100">
                <div class="col">
                    <div class="inputBox shorten-input">
                        <input  class="email-input" type="text" name="Email" value="<?= isset($Email) ? $Email:'' ?>">
            ...
            <div class="col">
                    <div class="inputBox">
                        <input type="Password" name="Pincode" value="<?= isset($Pincode) ? $Pincode:'' ?>" >
            ...
            <div class="row100">
                <div class="col">
                    <div class="inputBox shorten-input">
                        <input type="text" name="Phone_Number" value="<?= isset($Phone_Number) ? $Phone_Number:'' ?>">
            ...
            <div class="row100">
                <div class="col">
                       <div class="inputBox shorten-input">
                           <input  name="Birth_Date" type="text"  onfocus="(this.type='date')"  onblur="(this.type='text')" value="<?= isset($Birth_Date) ? $Birth_Date:'' ?>">
        ...
        <div class="row100">
            <div class="col">
                   <div class="inputBox shorten-input">
                       <input type="text" name="Nid" value="<?= isset($Nid) ? $Nid:'' ?>">
    ...
    <br><input type="file" name="Nid_Image"  accept="image/*" onchange="preview_image(event)">
        ...
        <div class="row100">
            <div class="col">
                <div class="inputBox textarea">
                    <textarea name="Security_Question_Answer"   cols="20" rows="7" ></textarea>
