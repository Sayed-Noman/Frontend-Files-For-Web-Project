...
<div id="page">
    ...
    <div id="work">
        ...
        <table>
            <tr class="work-1">
                <td>Nid Image:</td>
                <td> <?php  echo '<img src="data:image/jpeg;base64,'.base64_encode($rowValues['Nid_Image']).'" height="150" width="200"/>' ?></td>
            ...
            if($userType == 'Driver'){
                ...
                echo '<td><img src="data:image/jpeg;base64,'.base64_encode($rowValues['Driving_License_Image']).'" height="150" width="200"/></td>';
                 echo "</tr>";
