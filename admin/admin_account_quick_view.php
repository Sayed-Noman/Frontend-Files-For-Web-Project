...
<div id="page">
    <div class="photo-and-name">
        ...
        <?php
            if($userType == 'Police'){
                $Police_Profile_Picture=isset($rowValues['Police_Profile_Picture']);
                ...
                { 
                    echo '<img  class="photo" src="data:image/jpeg;base64,'.base64_encode($policeValues['Police_Profile_Picture']).'/>';  
        ...
        ?>
                 <?php
            if($userType == 'Admin'){
                $Admin_Profile_Picture=isset($rowValues['Admin_Profile_Picture']);
                ...
                { 
                    echo '<img  class="photo" src="data:image/jpeg;base64,'.base64_encode($adminValues['Admin_Profile_Picture']).'/>';  
