    ...
    function generateUniqeId($prefix){
        ...
        try{
            ...
            if($userType == 'Driver'){
                ...
                //print_r($Driver_Id);
                $driverTableInsertQuery="INSERT INTO `driver`(`Driver_Id`, `Address`, `Driver_Profile_Picture`, `Nationality`, `License_Type`, `License_Issue_Date`, `License_Expire_Date`, `Point`, `No_Of_Cases`, `Driver_Email_Fk`) VALUES ('$Driver_Id',NULL,NULL,NULL,NULL,NULL,NULL,15,0,(SELECT `Email` FROM `account` WHERE `Email`='$Email'))";
                $carTableInsertQuery="INSERT INTO `car`(`No_Plate`, `Car_Model`, `Brand_Name`, `Color`, `Vechile_Type`, `Car_Image`, `Car_Document_Image`, `Driver_Email_Fk`) VALUES (NULL,NULL,NULL,NULL,NULL,NULL,NULL,(SELECT `Email` FROM `account` WHERE `Email`='$Email'))";
            ...
            if($userType == 'Police'){
                ...
                $policeTableInsertQuery="INSERT INTO `police`(`Police_Id`, `Address`, `Police_Profile_picture`, `Nationality`, `Police_Department`, `Position`, `Region_Of_Work`, `No_Of_Cases_Filled`, `Police_Email_Fk`) VALUES ('$Police_Id',NULL,NULL,NULL,NULL,NULL,NULL,NULL,(SELECT `Email` FROM `account` WHERE `Email`='$Email'))";
                $emergencyInfoTableInsertQuery="INSERT INTO `emegencyinformation`(`Phone_Number`, `Address`, `Dependent_Name`, `Dependent_Relation`, `User_Email_Fk`) VALUES (NULL,NULL,NULL,NULL,(SELECT `Email` FROM `account` WHERE `Email`='$Email'))";
           ...
           if($userType == 'Admin'){
            ...
            $adminTableInsertQuery="INSERT INTO `admin`(`Admin_Id`, `Address`, `Nationality`, `Admin_Profile_Picture`, `Admin_Email_FK`) VALUES ('$Admin_Id',NULL,NULL,NULL,(SELECT `Email` FROM `account` WHERE `Email`='$Email'))";
            $emergencyInfoTableInsertQuery="INSERT INTO `emegencyinformation`(`Phone_Number`, `Address`, `Dependent_Name`, `Dependent_Relation`, `User_Email_Fk`) VALUES (NULL,NULL,NULL,NULL,(SELECT `Email` FROM `account` WHERE `Email`='$Email'))";
